...
void MainWindow::launchCalculating()
{
    ...
    file->resize(0);
    file->write("##########################\n\    Generated by Primus\n on " + QDateTime::currentDateTimeUtc().toString(Qt::ISODateWithMs).toUtf8() + "\nFrom: " + QByteArray::number(minSpin->value()) + "\nTo: " + QByteArray::number(maxSpin->value()) + "\n##########################\n\n");
    calculate();
}
...
void MainWindow::calculate()
{
    ...
    file->write(file->readAll() + "\n\nCalculating ended " + QDateTime::currentDateTimeUtc().toString(Qt::ISODateWithMs).toUtf8());
    ...
    file->write(file->readAll() + "\n\n################\nExaminated: " + QByteArray::number(max-min+1) + "\nFound: " + QByteArray::number(n) + "\nPercentage: " + QByteArray::number(ceil((double)n/(max-min+1)*100000)/1000));
    file->write(file->readAll() + "\n\nEnded " + QDateTime::currentDateTimeUtc().toString(Qt::ISODateWithMs).toUtf8());
    file->close();
}
